...
export const categories = [
  {
    ...
    description:
      "Here are the latest features we've added to allosCrm. I'm constantly improving our product to help you ship faster.",
    // A short version of the description above, only displayed in the <Header /> on mobile. Up to 60 characters.
    descriptionShort: "Latest features added to allosCrm.",
  },
  {
    ...
    description:
      "Learn how to use allosCrm with these step-by-step tutorials. I'll show you how to ship faster and save time.",
    descriptionShort:
      "Learn how to use allosCrm with these step-by-step tutorials.",
  },
];
...
export const articles = [
  {
    ...
    title: "Introducing Supabase to allosCrm",
    // The description of the article to display in the article page. Up to 160 characters. It's also used to generate the meta description.
    description:
      "Supabase is an open-source Firebase alternative. It's a great tool for building a backend for your app. It's now integrated with allosCrm!",
    ...
    image: {
      ...
      alt: "Supabase and allosCrm logo combined",
    },
  ...
  CONSTRAINT users_pkey PRIMARY KEY (id)
        ...
        <section>
          <h3 className={styles.h3}>2. Add your credentials to allosCrm</h3>
          <p className={styles.p}>
            Copy the <span className={styles.codeInline}>API URL</span> and{" "}
            <span className={styles.codeInline}>API Key</span> from your
            Supabase project settings and add them to your allosCrm project

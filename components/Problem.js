...
// For instance:
// - Hero: "allosCrm helps developers launch startups fast"
// - Problem Agitation: "Developers spend too much time adding features, get overwhelmed, and quit." (not about allosCrm at all)
// - Features: "allosCrm has user auth, Stripe, emails all set up for you"
const Problem = () => {
  return (
